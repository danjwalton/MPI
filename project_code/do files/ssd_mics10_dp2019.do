...
2019 Global Multidimensional Poverty Index - South Sudan MICS 2010
...
*** Working Folder Path ***
global path_in G:/My Drive/Work/GitHub/MPI//project_data/DHS MICS data files/South_Sudan_2010_MICS_Datasets
...
*** Merging MN Recode 
*****************************************
	//There is no male data file for South Sudan MICS 2010 
...
drop temp_f	
	...
	/* In the case of South Sudan, this variable takes missing value because the 
...
codebook hc8c hc8b hc8d hc9b hc8e hc9c hc9d hc11
...
save "$path_out/ssd_mics10.dta", replace 
