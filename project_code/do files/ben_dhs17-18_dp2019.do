...
2019 Global Multidimensional Poverty Index - Benin DHS 2017-18 [STATA do-file]. 
...
/*Benin DHS 2017-18 (p.3): In all households, children under 5 were weighed and 
measured to determine their nutritional status. This suggest, we may retain 
100% of the sample for global MPI analysis in the case of Benin. In addition, 
in a subsample of 50% of the households selected for the domestic violence 
module, all women aged 15-49 years were eligible for anthropometric 
measure.*/
...
compare tot_child_died tot_child_died_2
	//Note: Check that they are identical. Make a note confirming or denying.
...
foreach var in ha40 {
			 ...
			 Malawi DHS 2015-16 has anthropometric data only for women 
			 15-49 years
			 */
			 drop inf_`var'
			 }
