...
2019 Global Multidimensional Poverty Index - Afghanistan DHS 2015-16 
...
Afghanistan DHS 2015-16 dataset. It is not mentioned explicitly in the report. 
But the report does not have a specific chapter on 'Nutrition', which would have
been the case if anthropometric data was collected. In addition, under 
Chapter 1, the report stated all the topics covered by the questionnaire. 
...
tab resident, miss
	...
	In the context of Afghanistan DHS 2015-16, 1,942 (0.95%) individuals who 
...
/*In the context of Afghanistan DHS 2015-16, anthropometric data was not collected 
...
*****************************************
	/*In the context of Afghanistan, the variable hv042 has no 
...
gen	child_schoolage = (age>=7 & age<=15)
	/*
	Note: In Afghanistan, the official school entrance age to primary school 
...
*** Step 2.3 Nutrition ***
********************************************************************************
	/*Afghanistan DHS 2015-16 has no information on nutrition.*/
...
tab cookingfuel cooking_mdg, miss	
	...
	/*Note that in Afghanistan DHS 2015-16, the category 'other' cooking fuel 
	is not identified as solid fuel. Hence this particular category is 
