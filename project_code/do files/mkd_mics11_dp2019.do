...
2019 Global Multidimensional Poverty Index - The former Yugoslav Republic of 
Macedonia MICS 2011 [STATA do-file]. Available from OPHI website: 
http://ophi.org.uk/  
...
*** Working Folder Path ***
global path_in G:/My Drive/Work/GitHub/MPI//project_data/DHS MICS data files/Macedonia_2011_MICS_Datasets
...
/*Macedonia MICS 2011: Anthropometric data was collected only for childen under 
5 years as indicated by the questionnaire for children under-5 that was 
administered to mothers (or caretakers) (p.5; p.175) */
...
gen str30 datalab = "children_nutri_mkd" 
...
use "$path_out/children_nutri_mkd_z_rc.dta", clear 
...
erase "$path_out/children_nutri_mkd_z_rc.xls"
erase "$path_out/children_nutri_mkd_prev_rc.xls"
erase "$path_out/children_nutri_mkd_z_rc.dta" 
...
/* Note: There is no birth history data file for Macedonia MICS 2011. Hence this 
...
tab wb2, miss
	//193 women aged 15-49 years have no data on age

lookfor mort dead alive
	//Macedonia MICS 2011 has no birth/mortality information
...
/* Note: There is no male data file for Macedonia MICS 2011. Hence this section 
...
*** Merging MN Recode 
*****************************************
	//Macedonia MICS 2011 has no male data file
...
//Subnational region 
	/*Note: The primary objective of the sample design for the Macedonia MICS 
	2011 was to produce statistically reliable estimates of most indicators, at 
	the national level, for urban and rural areas, and for the eight regions 
...
/*On the basis of the amendments to the Law on Primary Education adopted on 20 
September 2004, primary education is compulsory for all children in the age 
group 6-15 years and includes: one preparatory pre-primary year, and two 
four-year cycles (classroom teaching, in grades 1-5 and subject teaching in 
grades 6-9). In accordance with the amendments introduced on 29th May 2007 
compulsory primary (basic education) lasts nine years divided into three 
three-year cycles. According to the changes and amendments to the Law on 
18th April 2007, secondary education is compulsory and free of charge in public 
educational institutions. It is provided in general education or specialized 
(languages and science-mathematics) gymnasia offering four-year programmes.

Total: 14 years of compulsory education.

Reference: http://unesdoc.unesco.org/images/0021/002145/214568e.pdf */

tab ed4b ed4a, miss
tab age ed6a if ed5==1, miss
	/*In the case of Macedonia MICS 2011, there is inconsistency such as 
...
replace eduyears = eduhighyear + 8 if edulevel==2 
	/*Secondary school assumed to start after 8 years of primary*/
replace eduyears = eduhighyear + 12 if (edulevel ==3)   
	/*Higher education assumed to start after 12 years of primary + 
	secondary education. The report on Macedonia's education, groups pre-school, 
	primary & secondary together under General Education. According to the 
	report (p. 7), basic education (including pre-school which is compulsory) 
	lasts 13 years under the 2007 model. We only considered 8 years of primary + 
...
gen	child_schoolage = (age>=6 & age<=14)
	/*
	Note: In Macedonia, the official school entrance age is 6 years.  
...
********************************************************************************
	/*NOTE: Macedonia MICS 2011 has no data on child mortality. As such the 
...
****************************************
	...
	not know where is considered as non-improved. However, in Macedonia, this 
	particular category is identified as improved sanitation facilities (p.57 
	...
	this is clearly a deprived standard. In addition, in Macedonia, the report, 
...
mentioned in the country report. In Macedonia, bottled water is considered
as an improved water source only if the household is using an improved water source for 
hand washing and cooking. (p.50)*/	
...
replace television =1 if hc8d==1
	//hc8d: information on plasma/lcd ownership.
gen bw_television = .	
clonevar radio = hc8b 
...
char _dta[cty] "TFYR of Macedonia"
char _dta[ccty] "MKD"
char _dta[year] "2011" 	
...
save "$path_out/mkd_mics11.dta", replace 
